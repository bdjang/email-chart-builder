...
horiz4capText.oninput = function() {
    ...
    if (horiz4capText.value == "") {
        horiz4Cap.style.paddingBottom = "0";
        return horiz4capCode = "";
    } else if (horiz4capText.value) {
        horiz4Cap.style.paddingBottom = "20px";
        return horiz4capCode = '<caption style="caption-side: top; color: #000000; font-family: Verdana, sans-serif; font-size: 14px; font-weight: 600; padding-bottom: 20px; text-align: left;">' + horiz4Cap.innerHTML + '</caption>';
    }
};
// Horizontal Chart IV Source
let horiz4sorCode;
const horiz4Source = document.getElementById("horiz4Source"); // Chart source
const horiz4sorText = document.getElementById("horiz4sorText"); // Chart source text
horiz4sorText.oninput = function() {
    horiz4Source.innerHTML = horiz4sorText.value;
    if (horiz4sorText.value == "") {
        horiz4Source.style.paddingTop = "0";
        return horiz4sorCode = "";
    } else if (horiz4sorText.value) {
        horiz4Source.style.paddingTop = "40px";
        return horiz4sorCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 12px; padding-top: 40px; text-align: left;">' + horiz4Source.innerHTML + '</td></tr>';
    }
};
