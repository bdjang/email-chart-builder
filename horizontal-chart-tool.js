...
horiz4capText.oninput = function() {
    ...
    if (horiz4capText.value == "") {
        ...
        return horiz4capCode = '<caption style="caption-side: top; color: #000000; font-family: Verdana, sans-serif; font-size: 14px; font-weight: 600; margin-bottom: 20px; text-align: left;">' + horiz4Cap.innerHTML + '</caption>';
    }
};
...
horiz4srcText.oninput = function() {
    ...
    if (horiz4srcText.value == "") {
        ...
        return horiz4srcCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 12px; padding-top: 40px; text-align: left;">' + horiz4Source.innerHTML + '</td></tr>';
    }
};
