...
const horiz4Caption = document.getElementById("horiz4Caption");
horiz4capText.oninput = function() {
    horiz4Caption.innerHTML = horiz4capText.value;
    if (horiz4capText.value == "") {
        horiz4Caption.style.paddingTop = "0";
    } else if (horiz4capText.value) {
        horiz4Caption.style.paddingTop = "40px";
    }
};
