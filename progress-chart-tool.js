...
let prog2VML1b; // Actual progress bar width; not grey color bar
let prog2VML1bInset;
let prog2VML1cInset;
...
prog2Size1.oninput = function() {
    ...
    prog2VML1b = Math.abs(prog2Size1.value / 100) * 560;
    prog2VML1bInset = (Math.abs(prog2Size1.value / 100) * 560) - 65;
    prog2VML1cInset = Math.abs(prog2Size1.value / 100) * 560;
};
...
let prog2VML2b; // Actual progress bar width; not grey color bar
let prog2VML2bInset;
let prog2VML2cInset;
...
prog2Size2.oninput = function() {
    ...
    prog2VML2b = Math.abs(prog2Size2.value / 100) * 560;
    prog2VML2bInset = (Math.abs(prog2Size2.value / 100) * 560) - 65;
    prog2VML2cInset = Math.abs(prog2Size2.value / 100) * 560;
};
...
let prog2VML3b; // Actual progress bar width; not grey color bar
let prog2VML3bInset;
let prog2VML3cInset;
...
prog2Size3.oninput = function() {
    ...
    prog2VML3b = Math.abs(prog2Size3.value / 100) * 560;
    prog2VML3bInset = (Math.abs(prog2Size3.value / 100) * 560) - 65;
    prog2VML3cInset = Math.abs(prog2Size3.value / 100) * 560;
};
...
let prog2VML4b; // Actual progress bar width; not grey color bar
let prog2VML4bInset;
let prog2VML4cInset;
...
prog2Size4.oninput = function() {
    ...
    prog2VML4b = Math.abs(prog2Size4.value / 100) * 560;
    prog2VML4bInset = (Math.abs(prog2Size4.value / 100) * 560) - 65;
    prog2VML4cInset = Math.abs(prog2Size4.value / 100) * 560;
};
...
let prog2VML5b; // Actual progress bar width; not grey color bar
let prog2VML5bInset;
let prog2VML5cInset;
...
prog2Size5.oninput = function() {
    ...
    prog2VML5b = Math.abs(prog2Size5.value / 100) * 560;
    prog2VML5bInset = (Math.abs(prog2Size5.value / 100) * 560) - 65;
    prog2VML5cInset = Math.abs(prog2Size5.value / 100) * 560;
};
...
prog2Button.addEventListener("click", () => {
    if (rowsData9.value === "1") {
        const chartCode = '<!--[if mso 15 | mso 16]><table align="center" border="0" cellpadding="0" cellspacing="0" width="600"><tr><td><![endif]--> <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;"> <tr> <td align="left" valign="top" bgcolor="#ffffff" style="background-color: #ffffff; border: 1px solid #e3e3e3; margin: 0; padding: 20px; width: 100%;"> <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"> <tr> <td align="left" style="padding: 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row1a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML1cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML1b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color1.value + '" stroke="false"> <v:textbox inset="' + prog2VML1bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color1.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1b.style.width + '; height: 28px;" height="28">' + prog2Row1b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1c.style.width + '; height: 28px;" height="28">' + prog2Row1c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr></table> </td></tr></table> <!--[if mso 15 | mso 16]></td></tr></table><![endif]-->';
        prog2Output.innerHTML = chartCode;
    } else if (rowsData9.value === "2") {
        const chartCode = '<!--[if mso 15 | mso 16]><table align="center" border="0" cellpadding="0" cellspacing="0" width="600"><tr><td><![endif]--> <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;"> <tr> <td align="left" valign="top" bgcolor="#ffffff" style="background-color: #ffffff; border: 1px solid #e3e3e3; margin: 0; padding: 20px; width: 100%;"> <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"> <tr> <td align="left" style="padding: 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row1a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML1cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML1b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color1.value + '" stroke="false"> <v:textbox inset="' + prog2VML1bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color1.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1b.style.width + '; height: 28px;" height="28">' + prog2Row1b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1c.style.width + '; height: 28px;" height="28">' + prog2Row1c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row2a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML2cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML2b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color2.value + '" stroke="false"> <v:textbox inset="' + prog2VML2bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color2.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2b.style.width + '; height: 28px;" height="28">' + prog2Row2b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2c.style.width + '; height: 28px;" height="28">' + prog2Row2c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr></table> </td></tr></table> <!--[if mso 15 | mso 16]></td></tr></table><![endif]-->';
        prog2Output.innerHTML = chartCode;
    } else if (rowsData9.value === "3") {
        const chartCode = '<!--[if mso 15 | mso 16]><table align="center" border="0" cellpadding="0" cellspacing="0" width="600"><tr><td><![endif]--> <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;"> <tr> <td align="left" valign="top" bgcolor="#ffffff" style="background-color: #ffffff; border: 1px solid #e3e3e3; margin: 0; padding: 20px; width: 100%;"> <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"> <tr> <td align="left" style="padding: 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row1a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML1cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML1b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color1.value + '" stroke="false"> <v:textbox inset="' + prog2VML1bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color1.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1b.style.width + '; height: 28px;" height="28">' + prog2Row1b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1c.style.width + '; height: 28px;" height="28">' + prog2Row1c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row2a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML2cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML2b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color2.value + '" stroke="false"> <v:textbox inset="' + prog2VML2bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color2.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2b.style.width + '; height: 28px;" height="28">' + prog2Row2b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2c.style.width + '; height: 28px;" height="28">' + prog2Row2c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row3a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML3cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row3c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML3b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color3.value + '" stroke="false"> <v:textbox inset="' + prog2VML3bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row3b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color3.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row3b.style.width + '; height: 28px;" height="28">' + prog2Row3b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row3c.style.width + '; height: 28px;" height="28">' + prog2Row3c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr></table> </td></tr></table> <!--[if mso 15 | mso 16]></td></tr></table><![endif]-->';
        prog2Output.innerHTML = chartCode;
    } else if (rowsData9.value === "4") {
        const chartCode = '<!--[if mso 15 | mso 16]><table align="center" border="0" cellpadding="0" cellspacing="0" width="600"><tr><td><![endif]--> <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;"> <tr> <td align="left" valign="top" bgcolor="#ffffff" style="background-color: #ffffff; border: 1px solid #e3e3e3; margin: 0; padding: 20px; width: 100%;"> <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"> <tr> <td align="left" style="padding: 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row1a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML1cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML1b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color1.value + '" stroke="false"> <v:textbox inset="' + prog2VML1bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color1.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1b.style.width + '; height: 28px;" height="28">' + prog2Row1b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1c.style.width + '; height: 28px;" height="28">' + prog2Row1c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row2a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML2cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML2b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color2.value + '" stroke="false"> <v:textbox inset="' + prog2VML2bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color2.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2b.style.width + '; height: 28px;" height="28">' + prog2Row2b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2c.style.width + '; height: 28px;" height="28">' + prog2Row2c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row3a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML3cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row3c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML3b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color3.value + '" stroke="false"> <v:textbox inset="' + prog2VML3bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row3b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color3.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row3b.style.width + '; height: 28px;" height="28">' + prog2Row3b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row3c.style.width + '; height: 28px;" height="28">' + prog2Row3c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row4a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML4cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row4c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML4b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color4.value + '" stroke="false"> <v:textbox inset="' + prog2VML4bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row4b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color4.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row4b.style.width + '; height: 28px;" height="28">' + prog2Row4b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row4c.style.width + '; height: 28px;" height="28">' + prog2Row4c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr></table> </td></tr></table> <!--[if mso 15 | mso 16]></td></tr></table><![endif]-->';
        prog2Output.innerHTML = chartCode;
    } else if (rowsData9.value === "5") {
        const chartCode = '<!--[if mso 15 | mso 16]><table align="center" border="0" cellpadding="0" cellspacing="0" width="600"><tr><td><![endif]--> <table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;"> <tr> <td align="left" valign="top" bgcolor="#ffffff" style="background-color: #ffffff; border: 1px solid #e3e3e3; margin: 0; padding: 20px; width: 100%;"> <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"> <tr> <td align="left" style="padding: 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row1a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML1cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML1b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color1.value + '" stroke="false"> <v:textbox inset="' + prog2VML1bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row1b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color1.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1b.style.width + '; height: 28px;" height="28">' + prog2Row1b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row1c.style.width + '; height: 28px;" height="28">' + prog2Row1c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row2a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML2cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML2b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color2.value + '" stroke="false"> <v:textbox inset="' + prog2VML2bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row2b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color2.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2b.style.width + '; height: 28px;" height="28">' + prog2Row2b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row2c.style.width + '; height: 28px;" height="28">' + prog2Row2c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row3a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML3cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row3c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML3b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color3.value + '" stroke="false"> <v:textbox inset="' + prog2VML3bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row3b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color3.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row3b.style.width + '; height: 28px;" height="28">' + prog2Row3b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row3c.style.width + '; height: 28px;" height="28">' + prog2Row3c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row4a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML4cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row4c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML4b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color4.value + '" stroke="false"> <v:textbox inset="' + prog2VML4bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row4b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color4.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row4b.style.width + '; height: 28px;" height="28">' + prog2Row4b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row4c.style.width + '; height: 28px;" height="28">' + prog2Row4c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr><tr> <td align="left" style="padding: 14px 0 0 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" class="chartMobile"> <tr> <td align="left" style="background-color: #ffffff; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: auto; height: 28px;" height="28">' + prog2Row5a.innerHTML + '</td></tr></table><!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: 560px; position: relative; z-index: 0;" arcsize="50%" fill="true" fillcolor="#e3e3e3" stroke="false"> <v:textbox inset="' + prog2VML5cInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row5c.innerHTML + '</span> </v:textbox> </v:roundrect> <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" style="height: 28px; width: ' + prog2VML5b + 'px; position: relative; z-index: 1;" arcsize="50%" fill="true" fillcolor="' + prog2Color5.value + '" stroke="false"> <v:textbox inset="' + prog2VML5bInset + 'px, 0px, 0px, 0px"> <span style="font-family: Courier, serif; font-size: 14px; color: #000000;">' + prog2Row5b.innerHTML + '</span> </v:textbox> </v:roundrect><![endif]--><!--[if !mso]><!--> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0" style="background-color: #e3e3e3; border-radius: 15px;" class="chartMobile"> <tr> <td align="right" style="background-color: ' + prog2Color5.value + '; border-radius: 15px; color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row5b.style.width + '; height: 28px;" height="28">' + prog2Row5b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Courier, serif; line-height: normal; margin: 0; padding: 0; width: ' + prog2Row5c.style.width + '; height: 28px;" height="28">' + prog2Row5c.innerHTML + '</td></tr></table> <!--<![endif]--> </td></tr></table> </td></tr></table> <!--[if mso 15 | mso 16]></td></tr></table><![endif]-->';
        prog2Output.innerHTML = chartCode;
    }
});
