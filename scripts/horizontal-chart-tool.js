...
horiz1capText.oninput = function() {
    ...
    if (horiz1capText.value == "") {
        ...
        return horiz1capCode = '<caption style="caption-side: top; color: #000000; font-family: Verdana, sans-serif; font-size: 14px; font-weight: 600; line-height: normal; margin-bottom: 4px; text-align: left;">' + horiz1Cap.innerHTML + '</caption>';
    } else if (horiz1subText.value == "" && horiz1capText.value) {
...
horiz1subText.oninput = function() {
    ...
    if (horiz1subText.value == "") {
        ...
        horiz1Cap.style.marginBottom = "4px";
        horiz1Sub.style.paddingBottom = "20px";
