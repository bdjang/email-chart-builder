...
horiz2capText.oninput = function() {
    ...
    if (horiz2capText.value == "" && horiz2subText.value == "") {
        ...
        horiz2Sub.style.paddingBottom = "0";
        return horiz2csCode = "";
    } else if (horiz2capText.value == "" && horiz2subText.value) {
        horiz2Cap.style.marginBottom = "0";
        return horiz2csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz2Sub.innerHTML + '</td> </tr>';
    } else if (horiz2capText.value && horiz2subText.value == "") {
...
horiz2subText.oninput = function() {
    ...
    if (horiz2subText.value == "" && horiz2capText.value == "") {
        ...
        horiz2Cap.style.marginBottom = "0";
        horiz2Sub.style.paddingBottom = "30px";
        return horiz2csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz2Sub.innerHTML + '</td> </tr>';
    } else if (horiz2subText.value && horiz2capText.value) {
        horiz2Cap.style.marginBottom = "4px";
        horiz2Sub.style.paddingBottom = "30px";
...
horiz3capText.oninput = function() {
    ...
    if (horiz3capText.value == "" && horiz3subText.value == "") {
        ...
        horiz3Sub.style.paddingBottom = "0";
        return horiz3csCode = "";
    } else if (horiz3capText.value == "" && horiz3subText.value) {
        horiz3Cap.style.marginBottom = "0";
        return horiz3csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz3Sub.innerHTML + '</td> </tr>';
    } else if (horiz3capText.value && horiz3subText.value == "") {
...
horiz3subText.oninput = function() {
    ...
    if (horiz3subText.value == "" && horiz3capText.value == "") {
        ...
        horiz3Cap.style.marginBottom = "0";
        horiz3Sub.style.paddingBottom = "30px";
        return horiz3csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz3Sub.innerHTML + '</td> </tr>';
    } else if (horiz3subText.value && horiz3capText.value) {
        horiz3Cap.style.marginBottom = "4px";
        horiz3Sub.style.paddingBottom = "30px";
...
horiz4capText.oninput = function() {
    ...
    if (horiz4capText.value == "" && horiz4subText.value == "") {
        ...
        horiz4Sub.style.paddingBottom = "0";
        return horiz4csCode = "";
    } else if (horiz4capText.value == "" && horiz4subText.value) {
        horiz4Cap.style.marginBottom = "0";
        return horiz4csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz4Sub.innerHTML + '</td> </tr>';
    } else if (horiz4capText.value && horiz4subText.value == "") {
...
horiz4subText.oninput = function() {
    ...
    if (horiz4subText.value == "" && horiz4capText.value == "") {
        ...
        horiz4Cap.style.marginBottom = "0";
        horiz4Sub.style.paddingBottom = "30px";
        return horiz4csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz4Sub.innerHTML + '</td> </tr>';
    } else if (horiz4subText.value && horiz4capText.value) {
        horiz4Cap.style.marginBottom = "4px";
        horiz4Sub.style.paddingBottom = "30px";
...
horiz4Button.addEventListener("click", () => {
    if (rowsData11.value === "1") {
        const chartCode = '<table role="presentation" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;"> <tr> <td align="left" valign="top" style="border: 1px solid #c4c4c4; margin: 0; padding: 20px; width: 100%;" class="chartMobile"> <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%"> ' + horiz4csCode + ' <tr> <td align="left" style="padding: 0;"> <table role="presentation" width="100%" border="0" cellspacing="0" cellpadding="0"> <tr> <td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Verdana, sans-serif; line-height: normal; margin: 0; padding: 0; width: 25%; height: 34px;" height="34">' + horiz4Row1a.innerHTML + '</td><td align="right" style="background-color: ' + horiz4Color1.value + '; color: #000000; font-weight: 400; font-size: 14px; font-family: Verdana, sans-serif; line-height: normal; margin: 0; padding: 0; width: ' + horiz4Row1b.style.width + '; height: 34px;" height="34">' + horiz4Row1b.innerHTML + '</td><td align="left" style="color: #000000; font-weight: 400; font-size: 14px; font-family: Verdana, sans-serif; line-height: normal; margin: 0; padding: 0; width: ' + horiz4Row1c.style.width + '; height: 34px;" height="34">' + horiz4Row1c.innerHTML + '</td></tr></table> </td></tr>' + horiz4srcCode + ' </table> </td></tr></table> ' + botSpace;
...
horiz5capText.oninput = function() {
    ...
    if (horiz5capText.value == "" && horiz5subText.value == "") {
        ...
        horiz5Sub.style.paddingBottom = "0";
        return horiz5csCode = "";
    } else if (horiz5capText.value == "" && horiz5subText.value) {
        horiz5Cap.style.marginBottom = "0";
        return horiz5csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz5Sub.innerHTML + '</td> </tr>';
    } else if (horiz5capText.value && horiz5subText.value == "") {
...
horiz5subText.oninput = function() {
    ...
    if (horiz5subText.value == "" && horiz5capText.value == "") {
        ...
        horiz5Cap.style.marginBottom = "0";
        horiz5Sub.style.paddingBottom = "30px";
        return horiz5csCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 14px; line-height: normal; padding-bottom: 30px; text-align: left;">' + horiz5Sub.innerHTML + '</td> </tr>';
    } else if (horiz5subText.value && horiz5capText.value) {
        horiz5Cap.style.marginBottom = "4px";
        horiz5Sub.style.paddingBottom = "30px";
