...
prog1srcText.oninput = function() {
    ...
    prog1Source.style.paddingTop = prog1srcText.value ? "20px" : "0";
    prog1srcCode = prog1srcText.value ? '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; line-height: normal; padding-top: 20px; text-align: left;">' + prog1Source.innerHTML + '</td></tr>' : "";
};
...
prog2srcText.oninput = function() {
    ...
    prog2Source.style.paddingTop = prog2srcText.value ? "20px" : "0";
    prog2srcCode = prog2srcText.value ? '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; line-height: normal; padding-top: 20px; text-align: left;">' + prog2Source.innerHTML + '</td></tr>' : "";
};
...
prog2Size1.oninput = function() {
    ...
    prog2VML1b = Math.max((Math.abs(prog2Size1.value / 100) * 520), 30).toFixed(2);
    prog2VML1bInset = Math.max(((Math.abs(prog2Size1.value / 100) * 520) - 50), 103).toFixed(2);
    prog2VML1cInset = Math.max((Math.abs(prog2Size1.value / 100) * 520), 30).toFixed(2);
...
prog2Size2.oninput = function() {
    ...
    prog2VML2b = Math.max((Math.abs(prog2Size2.value / 100) * 520), 30).toFixed(2);
    prog2VML2bInset = Math.max(((Math.abs(prog2Size2.value / 100) * 520) - 50), 103).toFixed(2);
    prog2VML2cInset = Math.max((Math.abs(prog2Size2.value / 100) * 520), 30).toFixed(2);
...
prog2Size3.oninput = function() {
    ...
    prog2VML3b = Math.max((Math.abs(prog2Size3.value / 100) * 520), 30).toFixed(2);
    prog2VML3bInset = Math.max(((Math.abs(prog2Size3.value / 100) * 520) - 50), 103).toFixed(2);
    prog2VML3cInset = Math.max((Math.abs(prog2Size3.value / 100) * 520), 30).toFixed(2);
...
prog2Size4.oninput = function() {
    ...
    prog2VML4b = Math.max((Math.abs(prog2Size4.value / 100) * 520), 30).toFixed(2);
    prog2VML4bInset = Math.max(((Math.abs(prog2Size4.value / 100) * 520) - 50), 103).toFixed(2);
    prog2VML4cInset = Math.max((Math.abs(prog2Size4.value / 100) * 520), 30).toFixed(2);
...
prog2Size5.oninput = function() {
    ...
    prog2VML5b = Math.max((Math.abs(prog2Size5.value / 100) * 520), 30).toFixed(2);
    prog2VML5bInset = Math.max(((Math.abs(prog2Size5.value / 100) * 520) - 50), 103).toFixed(2);
    prog2VML5cInset = Math.max((Math.abs(prog2Size5.value / 100) * 520), 30).toFixed(2);
...
prog3srcText.oninput = function() {
    ...
    prog3Source.style.paddingTop = prog3srcText.value ? "20px" : "0";
    prog3srcCode = prog3srcText.value ? '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; line-height: normal; padding-top: 20px; text-align: left;">' + prog3Source.innerHTML + '</td></tr>' : "";
};
...
prog3Size1.oninput = function() {
    ...
    prog3VML1b = Math.max((Math.abs(prog3Size1.value / 100) * 520), 30).toFixed(2);
    prog3VML1bInset = Math.max(((Math.abs(prog3Size1.value / 100) * 520) - 50), 103).toFixed(2);
    prog3VML1cInset = Math.max((Math.abs(prog3Size1.value / 100) * 520), 30).toFixed(2);
...
prog3Size2.oninput = function() {
    ...
    prog3VML2b = Math.max((Math.abs(prog3Size2.value / 100) * 520), 30).toFixed(2);
    prog3VML2bInset = Math.max(((Math.abs(prog3Size2.value / 100) * 520) - 50), 103).toFixed(2);
    prog3VML2cInset = Math.max((Math.abs(prog3Size2.value / 100) * 520), 30).toFixed(2);
...
prog3Size3.oninput = function() {
    ...
    prog3VML3b = Math.max((Math.abs(prog3Size3.value / 100) * 520), 30).toFixed(2);
    prog3VML3bInset = Math.max(((Math.abs(prog3Size3.value / 100) * 520) - 50), 103).toFixed(2);
    prog3VML3cInset = Math.max((Math.abs(prog3Size3.value / 100) * 520), 30).toFixed(2);
...
prog3Size4.oninput = function() {
    ...
    prog3VML4b = Math.max((Math.abs(prog3Size4.value / 100) * 520), 30).toFixed(2);
    prog3VML4bInset = Math.max(((Math.abs(prog3Size4.value / 100) * 520) - 50), 103).toFixed(2);
    prog3VML4cInset = Math.max((Math.abs(prog3Size4.value / 100) * 520), 30).toFixed(2);
...
prog3Size5.oninput = function() {
    ...
    prog3VML5b = Math.max((Math.abs(prog3Size5.value / 100) * 520), 30).toFixed(2);
    prog3VML5bInset = Math.max(((Math.abs(prog3Size5.value / 100) * 520) - 50), 103).toFixed(2);
    prog3VML5cInset = Math.max((Math.abs(prog3Size5.value / 100) * 520), 30).toFixed(2);
...
prog4srcText.oninput = function() {
    ...
    prog4Source.style.paddingTop = prog4srcText.value ? "20px" : "0";
    prog4srcCode = prog4srcText.value ? '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; line-height: normal; padding-top: 20px; text-align: left;">' + prog4Source.innerHTML + '</td></tr>' : "";
};
...
prog4Size1.oninput = function() {
    ...
    prog4VML1b = Math.max((Math.abs(prog4Size1.value / 100) * 520), 30).toFixed(2);
    prog4VML1bInset = Math.max(((Math.abs(prog4Size1.value / 100) * 520) - 50), 103).toFixed(2);
    prog4VML1cInset = Math.max((Math.abs(prog4Size1.value / 100) * 520), 30).toFixed(2);
...
prog4Size2.oninput = function() {
    ...
    prog4VML2b = Math.max((Math.abs(prog4Size2.value / 100) * 520), 30).toFixed(2);
    prog4VML2bInset = Math.max(((Math.abs(prog4Size2.value / 100) * 520) - 50), 103).toFixed(2);
    prog4VML2cInset = Math.max((Math.abs(prog4Size2.value / 100) * 520), 30).toFixed(2);
...
prog4Size3.oninput = function() {
    ...
    prog4VML3b = Math.max((Math.abs(prog4Size3.value / 100) * 520), 30).toFixed(2);
    prog4VML3bInset = Math.max(((Math.abs(prog4Size3.value / 100) * 520) - 50), 103).toFixed(2);
    prog4VML3cInset = Math.max((Math.abs(prog4Size3.value / 100) * 520), 30).toFixed(2);
...
prog4Size4.oninput = function() {
    ...
    prog4VML4b = Math.max((Math.abs(prog4Size4.value / 100) * 520), 30).toFixed(2);
    prog4VML4bInset = Math.max(((Math.abs(prog4Size4.value / 100) * 520) - 50), 103).toFixed(2);
    prog4VML4cInset = Math.max((Math.abs(prog4Size4.value / 100) * 520), 30).toFixed(2);
...
prog4Size5.oninput = function() {
    ...
    prog4VML5b = Math.max((Math.abs(prog4Size5.value / 100) * 520), 30).toFixed(2);
    prog4VML5bInset = Math.max(((Math.abs(prog4Size5.value / 100) * 520) - 50), 103).toFixed(2);
    prog4VML5cInset = Math.max((Math.abs(prog4Size5.value / 100) * 520), 30).toFixed(2);
