...
negative1srcText.oninput = function() {
    ...
    if (negative1srcText.value == "") {
        ...
        return negative1srcCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; padding-top: 40px; text-align: left;">' + negative1Source.innerHTML + '</td></tr>';
    }
};
...
negative2srcText.oninput = function() {
    ...
    if (negative2srcText.value == "") {
        ...
        return negative2srcCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; padding-top: 40px; text-align: left;">' + negative2Source.innerHTML + '</td></tr>';
    }
};
...
splitsrcText.oninput = function() {
    ...
    if (splitsrcText.value == "") {
        ...
        return splitsrcCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; padding-top: 40px; text-align: left;">' + splitSource.innerHTML + '</td></tr>';
    }
};
...
combo1capText.oninput = function() {
    ...
    if (combo1capText.value == "") {
        ...
        return combo1capCode = '<caption style="caption-side: top; color: #000000; font-family: Verdana, sans-serif; font-size: 14px; font-weight: 600; line-height: normal; padding-bottom: 30px; text-align: left;">' + combo1Cap.innerHTML + '</caption>';
    }
};
...
combo1srcText.oninput = function() {
    ...
    if (combo1srcText.value == "") {
        ...
        return combo1srcCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; padding-top: 40px; text-align: left;">' + combo1Source.innerHTML + '</td></tr>';
    }
};
...
combo2capText.oninput = function() {
    ...
    if (combo2capText.value == "") {
        ...
        return combo2capCode = '<caption style="caption-side: top; color: #000000; font-family: Verdana, sans-serif; font-size: 16px; font-weight: 600; line-height: normal; padding-bottom: 30px; text-align: left;">' + combo2Cap.innerHTML + '</caption>';
    }
};
...
combo2srcText.oninput = function() {
    ...
    if (combo2srcText.value == "") {
        ...
        return combo2srcCode = '<tr> <td style="color: #666666; font-family: Verdana, sans-serif; font-size: 11px; padding-top: 40px; text-align: left;">' + combo2Source.innerHTML + '</td></tr>';
    }
};
