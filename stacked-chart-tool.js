...
stacked2capText.oninput = function() {
    ...
    if (stacked2capText.value == "") {
        ...
        return stacked2capCode = '<caption style="caption-side: top; color: #000000; font-family: Verdana, sans-serif; font-size: 16px; font-weight: 600; line-height: normal; margin-bottom: 30px; text-align: left;">' + stacked2Cap.innerHTML + '</caption>';
    }
};
...
stacked4capText.oninput = function() {
    ...
    if (stacked4capText.value == "") {
        ...
        return stacked4capCode = '<caption style="caption-side: top; color: #000000; font-family: Verdana, sans-serif; font-size: 16px; font-weight: 600; line-height: normal; margin-bottom: 30px; text-align: left;">' + stacked4Cap.innerHTML + '</caption>';
    }
};
